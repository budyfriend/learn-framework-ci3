...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        // trim = menghilangkan space didepan dan dibelakang
        // is_unique = mengecek email yang ada ditabel ada yang sama tidak
        // matches = validasi kecocokan password
        if ($this->session->userdata('email')) {
            redirect('user');
        }
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $this->email->from('email-kamu@gmail.com', 'Budiono Edu');
